...
export const SITE = "https://littlepotato.me";
...
export const SITE_TITLE = "Bran Zhang";

// will be used in the meta tags (and for example shown in search results)
export const SITE_DESCRIPTION = "Personal notes, engineering writeups, and archived posts.";
...
export const SOURCE_LINK = "https://github.com/BranZhang/person-blog";
...
export const SOCIAL_LINKS: {
  ...
  SHOW_RSS: true,
  GITHUB_URL: "https://github.com/BranZhang",
};
