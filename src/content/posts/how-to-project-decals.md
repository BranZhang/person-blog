...
hiddenLocales: ["en"]
tags: ["WebGL"]
cover: "../../assets/wp-content/uploads/2022/03/decals.png"
---
...
![](../../assets/wp-content/uploads/2023/01/image-9.png "没贴花时的场景")
...
![](../../assets/wp-content/uploads/2023/01/image-10.png "贴花的位置")
...
![](../../assets/wp-content/uploads/2023/01/image-11.png "需要贴花的三角形")
...
![](../../assets/wp-content/uploads/2023/01/image-12.png "投影区域")

处于投影区域中的三角形看起来像这样：

![](../../assets/wp-content/uploads/2023/01/image-13.png)
...
![](../../assets/wp-content/uploads/2023/01/image-14.png "第一次标记")

可以把被标记的顶点移除。再来看下一条边。

![](../../assets/wp-content/uploads/2023/01/image-15.png "第二次标记")

当我们检查完每一条边之后，我们就得到了一个裁剪后的三角形。

![](../../assets/wp-content/uploads/2023/01/image-16.png "裁剪后的三角形")

当处理完每个三角形后，再将它们变换回世界坐标系中，我们就可以得到裁剪后的贴花网格了。

![](../../assets/wp-content/uploads/2023/01/image-17.png "裁剪后的组成贴花的三角形")
...
![](../../assets/wp-content/uploads/2023/01/image-18.png "测试纹理在贴花网格上的效果")

接下来就把真正的贴花纹理放上来，任务完成了！

![](../../assets/wp-content/uploads/2023/01/image-19.png "贴花正确的显示效果")

这是在最初的相机视角下的贴图效果。风化效果确实很轻微，但是我认为这样的额外细节能够让受风化的区域看起来更加的逼真。没有比这个更好的方式来将效果作用于一块区域了。

![](../../assets/wp-content/uploads/2023/01/image-20.png "实际的贴花效果")
