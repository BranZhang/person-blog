...
1. 从你的关键词研究中提取处于分布曲线头部的10~50个最常用的搜索词；
2. 在Google，雅虎，Bing中搜索这些关键词；
3. 对前10~30个结果中的每一个页面，提取页面上的独特的文字内容；
4. 剔除停用词，然后用词组长度过滤；
5. 剔除在你关键词研究数据库中已经存在的词和词组；
6. 将剩下的词按照常见度排序，梳理。
...
![](/wp-content/uploads/2019/10/google_search_console_click.png "站点目前状况，没人点击，太惨了")
...
- [SEO的艺术](https://book.douban.com/subject/24722613/)
- [SEO实战密码](https://book.douban.com/subject/5348144/)
