...
cover: "../../assets/wp-content/uploads/2025/05/image.png"
---
...
![](../../assets/wp-content/uploads/2025/05/image-1024x486.png "立交桥")

![](../../assets/wp-content/uploads/2025/05/image-1-1024x486.png "高架")

![](../../assets/wp-content/uploads/2025/05/image-2-1024x486.png "隧道")
...
![](../../assets/wp-content/uploads/2025/05/image-8.png)

### hd_road_elevation

这个数据集有点奇怪，肯定不是直接用于渲染的，它既有面数据也有点数据，根据名字看应该承载了道路高度信息，具体有啥用后面再说。

![](../../assets/wp-content/uploads/2025/05/image-9.png)

![](../../assets/wp-content/uploads/2025/05/image-11.png)

### hd_road_line

每一条车道两侧的边界线，也就是车道线，相邻的两个车道共用一条数据。应急车道的边界线也在其中。在渲染时可以是实线或者虚线。

![](../../assets/wp-content/uploads/2025/05/image-10.png)

### hd_road_point

这个数据集中包含了多种数据，道路两侧的植物，道路指示符号等。

![](../../assets/wp-content/uploads/2025/05/image-12.png)

![](../../assets/wp-content/uploads/2025/05/image-13.png)

### hd_road_polygon

这个数据集是面状数据，覆盖了上述的各种车道，应急车道，导流区等，可以简单的理解为，面状数据包含了所有与道路直接有关的数据，除了那些树木。

![](../../assets/wp-content/uploads/2025/05/image-14.png)
...
![](../../assets/wp-content/uploads/2025/05/expected-2.png "测试样例效果")
...
![](../../assets/wp-content/uploads/2025/05/image-5.png)
...
![](../../assets/wp-content/uploads/2025/05/image-6.png)

![](../../assets/wp-content/uploads/2025/05/image-7.png)

### road-hatched-area

导流区，通过 fill-pattern 实现的，所以需要准备好条纹状的纹理，这样实现无法控制纹理的走向。

![](../../assets/wp-content/uploads/2025/05/image-15.png)

### solid-lines，double-lines，dashed-lines

车道分界线，车道边缘线等。

![](../../assets/wp-content/uploads/2025/05/image-16.png)
...
![](../../assets/wp-content/uploads/2025/05/image-17-1024x453.png)

对于 elevationMode 不为 none 的 source，需要根据 elevationFeatures 来创建几何信息：

![](../../assets/wp-content/uploads/2025/05/image-18-1024x228.png)

对于一条数据，并不是所有的 elevationFeatures 都需要参与计算，在304行，代码根据 3d_elevation_id 来获取到对应的 tiledElevation 数据。

![](../../assets/wp-content/uploads/2025/05/image-19-1024x569.png)

![](../../assets/wp-content/uploads/2025/05/image-20-1024x208.png)

这时回过头来看上面的数据构成，hd_road_line 通过 3d_elevation_id 与 hd_road_elevation 数据关联，并从 hd_road_elevation 中获取到高度信息。

<Gallery
  images={[
    { src: "../../assets/wp-content/uploads/2025/05/image-24.png", caption: "" },
    { src: "../../assets/wp-content/uploads/2025/05/image-23.png", caption: "" },
  ]}
/>

看一下某个 elevationFeatures 的数据，顶点数组中包含了点位坐标和高度：

![](../../assets/wp-content/uploads/2025/05/image-25.png)

在 \3d-style\elevation\elevation_feature.ts 文件中，可以看到代码通过线性插值的方式来为特定的点位计算高度值。

![](../../assets/wp-content/uploads/2025/05/image-26-1024x376.png)
