...
![](../../assets/content-images/uploads/2021/01/image.png "“毒药”也是敏感词？")

## 原题解析

### 题目

请听题：[458. Poor Pigs](https://leetcode.com/problems/poor-pigs/)，题目中文描述如下：
...
给你桶的数目 *buckets*，*minutesToTest* 和 *minutesToDie* ，返回在规定时间内判断哪个桶有毒所需的**最小**猪数。

### 题解

#### 数学方法

毕竟，这条题目给的标签就是 **Math**，想通之后的解法也很简单，就是一个数学公式。以总时间 `minutesToTest = 60`，死亡时间 `minutesToDie = 15`为例：
...
那么，按照[《Turn dynamic programming into mathematical formula》](https://leetcode.com/problems/poor-pigs/discuss/94307/Turn-dynamic-programming-into-mathematical-formula)这篇文章中的思路，对应到上面三要素，
...
[《猪猪超进化：你的潜能，超乎你的想象！》](https://mp.weixin.qq.com/s/JgColmETAH7Es81iM1dOeQ)这篇文章从各种方案实施的角度，列举了多种实施方式，得出的最少小猪使用量均为10只。但却无法证明是否可能只用9只小猪。
...
- 算法题中文描述：[https://leetcode-cn.com/problems/poor-pigs/](https://leetcode-cn.com/problems/poor-pigs/)
- 算法题解法：[https://leetcode-cn.com/problems/poor-pigs/solution/](https://leetcode-cn.com/problems/poor-pigs/solution/)
...
- 动态规划到通项公式：[https://leetcode-cn.com/problems/poor-pigs/solution/dong-tai-gui-hua-dao-tong-xiang-gong-shi-by-defeat/](https://leetcode-cn.com/problems/poor-pigs/solution/dong-tai-gui-hua-dao-tong-xiang-gong-shi-by-defeat/)
- 经典信息论题目：[https://leetcode-cn.com/problems/poor-pigs/solution/jing-dian-xin-xi-lun-ti-mu-by-pi-xie-wang-bei-luo/](https://leetcode-cn.com/problems/poor-pigs/solution/jing-dian-xin-xi-lun-ti-mu-by-pi-xie-wang-bei-luo/)
- 1000桶水中两桶有毒，猪喝毒水后会在15分钟内死去，想用一个小时找到毒水，至少需要几只猪？：[https://www.zhihu.com/question/60461214](https://www.zhihu.com/question/60461214)
