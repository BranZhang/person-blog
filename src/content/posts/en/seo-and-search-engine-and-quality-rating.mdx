...
![](/wp-content/uploads/2019/10/rating_duplicate.png "Duplicate and containment options in a map-data labeling platform")
...
<Gallery
  images={[
    { src: "/wp-content/uploads/2019/10/rating_search.png", caption: "Straight-line distance from the user as a map-search relevance factor" },
    { src: "/wp-content/uploads/2019/10/rating_search3.png", caption: "Viewport-relative distance can follow the screen boundary rather than a circle" },
  ]}
/>
