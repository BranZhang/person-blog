...
static buildGeoJSON(coord, train_index, train_type, angle) {
    ...
    if (train_type === "\u52a8\u8f66\u7ec4" && (train_index===0 || train_index===8)) { // EMU
        singe_type = "normal_head";
    }
    else if (train_type === "\u52a8\u8f66\u7ec4" && (train_index===7 || train_index===15)) { // EMU
        singe_type = "normal_tail";
    }
    else if (train_type === "\u9ad8\u901f\u94c1\u8def" && (train_index===0 || train_index===8)) { // high-speed rail
        singe_type = "high_head";
    }
    else if (train_type === "\u9ad8\u901f\u94c1\u8def" && (train_index===7 || train_index===15)) { // high-speed rail
