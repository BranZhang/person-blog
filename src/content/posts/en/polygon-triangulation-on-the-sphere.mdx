...
![](../../../assets/content-images/uploads/2025/02/Geometry_geodesic_vs_planar_annotated.png "Geodesic polygon in red and planar polygon in black")
...
<Gallery
  images={[
    { src: "../../../assets/content-images/uploads/2025/02/bad_triangulation.avif", caption: "Incorrect CesiumJS triangulation of a polygon that wraps around the world" },
    { src: "../../../assets/content-images/uploads/2025/02/good_triangulation.avif", caption: "Correct triangulation in CesiumJS" },
  ]}
/>
...
![](../../../assets/content-images/uploads/2025/02/triangulation.avif "CesiumJS triangulates a polygon with earcut before displaying it on the ellipsoid")
...
![](../../../assets/content-images/uploads/2025/02/tangent.avif "Projecting an ellipsoidal polygon to a tangent plane for 2D triangulation")
...
![](../../../assets/content-images/uploads/2025/02/split.avif "Splitting an ellipsoid into eight regions along the x-, y-, and z-axes")
...
![](../../../assets/content-images/uploads/2025/02/stereographic_map.avif "A conformal map projection preserves shape at the cost of area distortion")
...
![](../../../assets/content-images/uploads/2025/02/sterographic_projection.avif "Stereographic projection of positions P and Q onto the opposite polar plane")
...
![](../../../assets/content-images/uploads/2025/02/sterograohic_triangulation.png "Stereographic triangulation preserves angles even when a polygon wraps around the ellipsoid")
...
![](../../../assets/content-images/uploads/2025/02/inside_outside.avif "Pole containment is essential for determining the correct map bounding rectangle")

With the projection handled correctly, the polygon renders as intended.

<Gallery
  images={[
    { src: "../../../assets/content-images/uploads/2025/02/enclosing_pole_before.avif", caption: "Incorrect polar polygon" },
    { src: "../../../assets/content-images/uploads/2025/02/enclosing_pole_after.avif", caption: "Correctly rendered polygon" },
  ]}
/>
...
<Gallery
  images={[
    { src: "../../../assets/content-images/uploads/2025/02/polygon-equirectangular-panorama.jpg", caption: "An equirectangular panorama is a distorted 2D projection in which straight lines in 3D appear curved" },
    { src: "../../../assets/content-images/uploads/2025/02/polygon-undistorted.jpg", caption: "Rendering the panorama on a sphere restores straight lines in undistorted 3D space" },
  ]}
/>
...
![](../../../assets/content-images/uploads/2025/02/polygon-rendered.jpg "Different colors identify segmentation classes")
...
<Gallery
  images={[
    { src: "../../../assets/content-images/uploads/2025/02/polygon-on-real-image.png", caption: "A hexagon detected in the distorted equirectangular projection" },
    { src: "../../../assets/content-images/uploads/2025/02/polygon-on-undistorted-image.png", caption: "The same polygon changes shape in undistorted 3D space" },
  ]}
/>
...
![](../../../assets/content-images/uploads/2025/02/6-subareas.png "A hexagon crossing a grid of six projection regions")
...
![](../../../assets/content-images/uploads/2025/02/clipped-areas.png "The polygon clipped to each projection region")
...
![](../../../assets/content-images/uploads/2025/02/sphere-areas.png "Clipped polygon pieces unprojected onto the sphere")

The projected piece can now be triangulated in 2D and filled with color.

![](../../../assets/content-images/uploads/2025/02/clipped-polygon.png "A triangulated clipped polygon piece")
...
![](../../../assets/content-images/uploads/2025/02/polygon-combined-sphere.png "The hexagon rendered correctly in undistorted 3D space")
