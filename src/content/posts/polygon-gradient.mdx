...
<Gallery
  images={[
    { src: "../../assets/wp-content/uploads/2022/12/image-9.png", caption: "热力图" },
    { src: "../../assets/wp-content/uploads/2022/12/image-8.png", caption: "基于高程的分层设色" },
    { src: "../../assets/wp-content/uploads/2022/12/image-7.png", caption: "线段的渐变" },
  ]}
  caption="普通的渐变色"
/>
...
![](../../assets/wp-content/uploads/2022/12/image-10-1024x730.png "渐变色作为阴影的使用")
...
![](../../assets/wp-content/uploads/2022/12/image-6-1024x585.png "Cesium 中的渐变效果（网图）")

在一些桌面端的 GIS 软件中，是有多边形渐变的效果的，比如 QGIS。在 QGIS 里这一效果叫“shapeburst fill”。用来突出显示一个区域，或者显示水系的阴影。

<Gallery
  images={[
    { src: "../../assets/wp-content/uploads/2022/12/image-13.png", caption: "水系阴影" },
    { src: "../../assets/wp-content/uploads/2022/12/image-11-1024x569.png", caption: "区域高亮" },
  ]}
...
<Gallery
  images={[
    { src: "../../assets/wp-content/uploads/2022/12/image-14.png", caption: "多边形直骨架" },
    { src: "../../assets/wp-content/uploads/2022/12/image-15.png", caption: "渐变填充" },
  ]}
/>
...
![](../../assets/wp-content/uploads/2022/12/image-17.png "*尖角形*拐角")

![](../../assets/wp-content/uploads/2022/12/image-16.png "*圆形*拐角")
...
<Gallery
  images={[
    { src: "../../assets/wp-content/uploads/2022/12/image-18.png", caption: "直骨架算法输出结果" },
    { src: "../../assets/wp-content/uploads/2022/12/image-19.png", caption: "切割钝角" },
  ]}
/>
